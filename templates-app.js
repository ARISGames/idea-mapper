...
angular.module("charts/charts.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("charts/charts.tpl.html",
    "<div class=\"row\">\n" +
    "   <div id=\"work-area-bg\" class=\"work-area col-sm-9 col-sm-offset-1 paper chart-frame\"></div>\n" +
    "	<div id=\"work-area\" class=\"work-area col-sm-9 col-sm-offset-1 chart-frame\" ui-view></div>\n" +
    "</div>");
}]);
...
angular.module("step1/step1.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("step1/step1.tpl.html",
    ...
    "	    </div>\n" +
    "	</div>		 \n" +
    "   <div id=\"work-area-bg\" class=\"work-area col-sm-9 paper animated step1-work-area-animation\"></div>\n" +
    "	<div id=\"work-area\" class=\"work-area col-sm-9 animated step1-work-area-animation\" ui-view></div>\n" +
    "</div>");
}]);
...
angular.module("step2/step2.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("step2/step2.tpl.html",
    ...
    "\n" +
    "	</div>		    \n" +
    "   <div id=\"work-area-bg\" class=\"work-area col-sm-9 paper slide\"></div>\n" +
    "	<div id=\"work-area\" class=\"work-area col-sm-9 slide\" ui-view></div>\n" +
    "</div>\n" +
    "");
}]);

angular.module('thinkingVisually.numericStepper', [])
...
.directive('numericStepper', function() {
    return {
        ...
        template: '<button type="button" ng-disabled="isOverMin()" ng-click="decrement()" class="btn-minus voffset2"></button>' +
                  '<div id="numericStepperValue" class="numericStepper-value"></div>' +
                  '<button type="button" ng-disabled="isOverMax()" ng-click="increment()" class="btn-plus voffset2"></button>',
